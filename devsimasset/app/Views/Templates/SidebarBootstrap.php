<div class="wrapper">
		...
		<div class="sidebar-wrapper" data-simplebar="true">
			<div class="sidebar-header">
				<div>
					<img src="/assets/images/ypt.png" class="logo-icon" alt="logo icon">
				</div>
				<div>
					<h4 class="logo-text">SIM Aset</h4>
				</div>
			...
			<ul class="metismenu" id="menu">
				...
				<li>
					...
					<ul>
						<li> <a href="<?=base_url('table/view')?>"><i class="bx bx-right-arrow-alt"></i>Data Table</a>
						</li>
					</ul>
				</li>
